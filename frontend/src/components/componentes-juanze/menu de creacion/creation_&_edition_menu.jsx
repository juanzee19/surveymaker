...
<div className='box-white'>
      <input type='text' className='edit__survey__name' placeholder=' New Survey'></input> 
        
        <div className='main'> 
        <div className='items__and__buttons'>
       
        <button onClick={() => navigate('/survey')} className='create__new' title='Crear un nuevo item'>
  New item +
</button>
        ...
        <p className='visi__p'>Quien puede ver esta encuesta?</p>
          <div className='h1__and__checkbox'>  
            ...
            <ol className='visibilidad__list'>
              <li className='visibilidad__item'>Todos
                <input type='checkbox'/>
              </li>
              <li className='visibilidad__item'>Url
              <input type='checkbox'/>
              </li>
              <li className='visibilidad__item'>Gmail
              <input type='checkbox'/>
              </li>
            </ol>
          </div>
